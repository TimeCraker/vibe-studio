...
| [`video-motion`](skills/video-motion/) | **视频动效合成**：视频底材叠字幕 / 数据动效 / 圈注 + PPT 逐页成片（一套 Remotion 引擎两种成片） | 已上线（[首站 Spec](docs/2026-08-29-video-motion-stage-spec.md) · [逐页成片 Spec](docs/2026-08-29-deck-video-stage-spec.md)） |
